...
const Untitled1 = () => {
  return <SafeAreaView style={styles.safeArea}>
      ...
      position: 'relative',
      flex: 1
    }}><Text style={styles.djpOkMpT}>Lorem ipsum…</Text><ImageBackground style={styles.lSqazqTz} source={{
      ...
      }} resizeMode="cover"></ImageBackground><View style={styles.VlnBgBHi}></View></ScrollView>
    </SafeAreaView>;
};
